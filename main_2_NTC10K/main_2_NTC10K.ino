...
void setup() {
  ...
  Serial.print("Tempo");
  Serial.print(",");
  Serial.print("Tntc1 medio");
  Serial.print(",");
  Serial.print("T_ntc1");
  Serial.print(",");
  Serial.print("Tntc2 medio");
  Serial.print(",");
  Serial.println("Tntc2");
...
void loop() {
  ...
  for(int i = 0; i < numero_de_amostras; i++){
    ...
    valor_do_sensor2 = analogRead(ntc2);
    //R = transforma_input_em_R(valor_do_sensor);
    temperatura2 = get_temperatura_ntc(valor_do_sensor2);
